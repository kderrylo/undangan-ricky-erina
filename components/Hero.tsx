...
export default function Hero() {
  return (
    ...
    >
      ...
      <FloralOrnament flip className="pointer-events-none absolute -right-8 -bottom-8 h-44 w-44 animate-float text-lilac-300 opacity-60 sm:h-60 sm:w-60" style={{ animationDelay: '1.5s' }} />
